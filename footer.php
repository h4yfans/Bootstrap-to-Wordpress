	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				...
				<p><a href="#" class="btn btb-lg btn-block btn-success">Yes, sign me up!</a></p>
			</div>
		</div><!--row-->
	</div><!--container-->
</section><!--signup-->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><i class="fa fa-envelope"></i> Subscribe to out Mailing List
				</h4>
			</div><!--modal-header-->
			<div class="modal-body">
				<p>Simply enter your name and email! As a thank you for joining us, we're going to hive you one of our
				...
				<form action="" class="form-inline" role="form">
					...
					<div class="form-group">
						<label for="subscribe-email" class="sr-only">Your your email </label>
				...
				<p>
					<small>By providing your email you consent to receiving occasional promotional emails &amp;
						newsletters.
						<br>No Spam. Just good stuff. We respect your privacy &amp; you may unsubscribe at any time.
					</small>
				</p>
			</div><!--modal-body-->
